...
#define SIMD_DOUBLE4X4_FROM_FILAMENT(m) (simd_matrix( \
...
namespace filament {
    namespace math {
        namespace details {
            inline filament::math::details::TMat44<float>
            simdMultiply4x4(filament::math::details::TMat44<float> matrix1,
                            filament::math::details::TMat44<float> matrix2) {
              simd_float4x4 simdMat1 = SIMD_FLOAT4X4_FROM_FILAMENT(matrix1);
              simd_float4x4 simdMat2 = SIMD_FLOAT4X4_FROM_FILAMENT(matrix2);
              simd_float4x4 ret = simd_mul(simdMat1, simdMat2);
              return FILAMENT_MAT4F_FROM_SIMD(ret);
            }

            inline filament::math::details::TMat44<double>
            simdMultiply4x4(filament::math::details::TMat44<double> matrix1,
                            filament::math::details::TMat44<double> matrix2) {
              simd_double4x4 simdMat1 = SIMD_DOUBLE4X4_FROM_FILAMENT(matrix1);
              simd_double4x4 simdMat2 = SIMD_DOUBLE4X4_FROM_FILAMENT(matrix2);
              simd_double4x4 ret = simd_mul(simdMat1, simdMat2);
              return FILAMENT_MAT4_FROM_SIMD(ret);
            }
            ...
            inline filament::math::details::TMat44<float>
            simdInverseMatrix4x4(filament::math::details::TMat44<float> matrix) {
              simd_float4x4 simdMat = SIMD_FLOAT4X4_FROM_FILAMENT(matrix);
              simd_float4x4 inv = simd_inverse(simdMat);
              return FILAMENT_MAT4F_FROM_SIMD(inv);
            }

            inline filament::math::details::TMat44<double>
            simdInverseMatrix4x4(filament::math::details::TMat44<double> matrix) {
              simd_double4x4 simdMat = SIMD_DOUBLE4X4_FROM_FILAMENT(matrix);
              simd_double4x4 inv = simd_inverse(simdMat);
              return FILAMENT_MAT4_FROM_SIMD(inv);
            }
        }
    }
}
