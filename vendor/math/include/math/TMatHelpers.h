...
#ifdef FILAMENT_ENV_IOS
// 仅对iOS启用simd优化
    #define kEnableSIMDForiOS 1
#else
#define kEnableSIMDForiOS 0
#endif

#if kEnableSIMDForiOS
namespace filament {
    namespace  math {
        namespace  details {
            ...
            // 这几个函数在iOS上层实现了
            extern filament::math::details::TMat44<float> simdMultiply4x4(filament::math::details::TMat44<float> matrix1, filament::math::details::TMat44<float> matrix2);
            extern filament::math::details::TMat44<double> simdMultiply4x4(filament::math::details::TMat44<float> matrix1, filament::math::details::TMat44<double> matrix2);
            extern filament::math::details::TMat44<double> simdMultiply4x4(filament::math::details::TMat44<double> matrix1, filament::math::details::TMat44<double> matrix2);
            extern filament::math::details::TMat44<double> simdMultiply4x4(filament::math::details::TMat44<double> matrix1, filament::math::details::TMat44<float> matrix2);


            extern filament::math::details::TMat44<float> simdInverseMatrix4x4(filament::math::details::TMat44<float> matrix);
            extern filament::math::details::TMat44<double> simdInverseMatrix4x4(filament::math::details::TMat44<double> matrix);
        }
    }
}
            ...
            namespace matrix {
                ...
                template<typename MATRIX_R, typename MATRIX_A, typename MATRIX_B,
                        typename = std::enable_if_t<
                                ...
                                !(MATRIX_A::NUM_COLS == 4 && MATRIX_A::NUM_ROWS == 4 && MATRIX_B::NUM_COLS == 4 && MATRIX_B::NUM_ROWS == 4) &&
                ...
                template<typename MATRIX_R, typename MATRIX_A, typename MATRIX_B,
                        typename = std::enable_if_t<
                                ...
                                MATRIX_R::NUM_COLS == MATRIX_B::NUM_COLS &&
                                MATRIX_R::NUM_ROWS == MATRIX_A::NUM_ROWS, int>,
                        typename = std::enable_if_t<std::is_same<filament::math::details::TMat44<float>, MATRIX_A>::value>,
                        typename = std::enable_if_t<
                                MATRIX_A::NUM_COLS == MATRIX_B::NUM_ROWS &&
                                MATRIX_R::NUM_COLS == MATRIX_B::NUM_COLS &&
                                (MATRIX_A::NUM_COLS == 4 && MATRIX_A::NUM_ROWS == 4 && MATRIX_B::NUM_COLS == 4 && MATRIX_B::NUM_ROWS == 4) &&
                ...
                constexpr MATRIX_R MATH_PURE multiply(MATRIX_A lhs, MATRIX_B rhs) {
                    ...
                    //  rhs : C columns, D rows
                    //  res : C columns, R rows
                    return filament::math::details::simdMultiply4x4(lhs, rhs);
                }
                ...
                template<typename MATRIX_R, typename MATRIX_A, typename MATRIX_B,
                        typename = std::enable_if_t<
                                ...
                                MATRIX_R::NUM_COLS == MATRIX_B::NUM_COLS &&
                                MATRIX_R::NUM_ROWS == MATRIX_A::NUM_ROWS, int>,
                        typename = std::enable_if_t<std::is_same<filament::math::details::TMat44<double>, MATRIX_A>::value>,
                        typename = std::enable_if_t<std::is_same<filament::math::details::TMat44<double>, MATRIX_B>::value>,
                        typename = std::enable_if_t<
                                MATRIX_A::NUM_COLS == MATRIX_B::NUM_ROWS &&
                                MATRIX_R::NUM_COLS == MATRIX_B::NUM_COLS &&
                                (MATRIX_A::NUM_COLS == 4 && MATRIX_A::NUM_ROWS == 4 && MATRIX_B::NUM_COLS == 4 && MATRIX_B::NUM_ROWS == 4) &&
...
template<typename MATRIX,
        typename = std::enable_if_t<
                MATRIX::NUM_COLS != 4 &&
                MATRIX::NUM_ROWS == MATRIX::NUM_COLS, int>>
inline constexpr MATRIX MATH_PURE inverse(const MATRIX& matrix) {
    return (MATRIX::NUM_ROWS == 2) ? fastInverse2<MATRIX>(matrix) :
           ((MATRIX::NUM_ROWS == 3) ? fastInverse3<MATRIX>(matrix) :
            gaussJordanInverse<MATRIX>(matrix));
...
template<typename MATRIX,
        ...
        typename = std::enable_if_t<
                MATRIX::NUM_COLS == 4 &&
                MATRIX::NUM_ROWS == 4, int> >
inline constexpr MATRIX MATH_PURE inverse(const MATRIX& matrix) {
    return simdInverseMatrix4x4(matrix);
}
